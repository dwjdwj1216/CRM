                            ...
                            <div style="width: 90%;border: 1px solid #000;margin: 0 auto;font-size: 10px;">
                                <div style="width: 90%;margin: 10px auto; font-size: 10px">
                                    <c:forEach items="${saleChances}" var="saleChance">
                                        <div >
                                            <span style="position:absolute;left:12.5%;font-size: 18px;">${saleChance.protentialCustomerName}</span>
                                            <span style="position:absolute;left:20%;">${saleChance.protencialCustomerPhone}</span>
                                            <span style="position: absolute;left:28%;font-size: 18px">
                                            ...
                                            <c:if test="${saleChance.chanceStage!='unassigned'}">
                                                <button style="position: absolute;left:45%;" onclick="javascript:window.location.href='/sale/saleChanceInfo/${saleChance.chanceNumber}'">查看详细信息</button>
                                            </c:if>
                                            <c:if test="${saleChance.chanceStage=='unassigned'}">
                                                <button style="position: absolute;left: 51%;" onclick="javascript:window.location.href='/sale/distributionSaleChance/${saleChance.chanceNumber}'">分配</button>
                                            </c:if>
                                            <span style="position:absolute;left: 70%">${saleChance.productName}&nbsp;&nbsp;${saleChance.productCount}</span>
                                            <span style="position:absolute;left: 80%">${saleChance.chanceTime}</span>
                                        </div>
                                        <br>
                                        <hr style="height:1px;border:none;border-top:1px solid #000;margin-top: 5px;margin-left: 4%;margin-right: 4%;margin-bottom: 1px" />
