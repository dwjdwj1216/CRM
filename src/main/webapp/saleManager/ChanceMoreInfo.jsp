                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div style="width:95%;border: 1px solid #000;position: relative;left: 2.5%;top: 10px;">
                            <span>销售机会跟进记录</span>
                            <%--<button  style="position: relative;left: 50%;top:5px;" onclick="javascript:window.location.href='/client/addFollow/${saleChance.chanceNumber}'">增加销售机会跟进记录</button>--%>
                            <c:forEach var="chanceFollow" items="${chanceFollows}">
                                <div style="width:90%;border: 1px solid #000;position: relative;left: 5%;top: 10px;">
                                    <div >

                                        <span style="position: absolute;left: 10%;top:10px;font-size: 5px;" > <c:if test="${chanceFollow.followStage=='advisory'}">咨询阶段</c:if>
                            ...
                            <c:if test="${chanceFollow.followStage=='failure'}">失败</c:if>
                                        ...
                                        <span style="position: absolute;left: 70%;top:10px;font-size: 5px;" >${chanceFollow.followTime}</span>
                                    </div>
                                    <br>
