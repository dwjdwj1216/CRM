        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="/client/editCustomerState/${customerID}" method="post">
                        <select name="state">
                            <option value="1" <c:if test="${state=='1'}">selected="selected"</c:if>>正常</option>
                            <option value="0" <c:if test="${state=='0'}">selected="selected"</c:if>>暂缓</option>
                            <option value="-1" <c:if test="${state=='-1'}">selected="selected"</c:if>>流失</option>
                        </select>
                        </form>
                        <!-- PAGE CONTENT ENDS -->
                    </div><!-- /.col -->
