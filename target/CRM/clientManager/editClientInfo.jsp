            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form method="post" action="/client/edit/${customerNumber}">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                        ...
                        <br>
                        <button onclick="javascript:window.location.href='/client/editCustomerState/${customer.customerNumber}'">修改客户状态</button>

                        <button onclick="javascript:window.location.href='/client/getClientList/all/all/1'">取消</button>
