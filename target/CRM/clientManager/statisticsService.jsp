            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="main_body">
                            <form action="/client/statisticsService" method="post">
                                <input onclick="laydate()" name="beginTime"/>
                                <input onclick="laydate()" name="endTime"/>
                            ...
                            <table class="myTable" border="1">
                                ...
                                <c:forEach items="${services}" var="service">
                                    <tr>
                                        <td><c:out value="${service.customerNumber}"/></td>
                                        <td><c:out value="${service.customerName}"/></td>
