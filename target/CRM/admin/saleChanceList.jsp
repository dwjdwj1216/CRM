                                ...
                                <div style="width: 90%;margin: 10px auto; font-size: 10px">
                                    <c:forEach items="${saleChances}" var="saleChance">
                                        <div >
                                            ...
                                            <c:if test="${saleChance.chanceStage!='unassigned'}">
                                                <button style="position: absolute;left:45%;" onclick="javascript:window.location.href='/admin/saleChanceInfo/${saleChance.chanceNumber}'">查看详细信息</button>
                                            </c:if>
                                                <button style="position: absolute;left: 51%;" onclick="javascript:window.location.href='/admin/deleteChance/${saleChance.chanceNumber}'">删除</button>
                                        ...
                                        <br>
                                        <hr style="height:1px;border:none;border-top:1px solid #000;margin-top: 8px;margin-left: 4%;margin-right: 4%;margin-bottom: 5px" />
